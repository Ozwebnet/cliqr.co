...
const NotificationPreferencesDialog = ({ open, onOpenChange, preferences, onPreferencesUpdated }) => {
  const { user } = useAuth();
      ...
      <DialogContent className="sm:max-w-2xl bg-slate-900/90 backdrop-blur-md border-slate-700 text-white overflow-y-auto max-h-[90vh]">
        ...
        <DialogFooter className="p-6 pt-0">
          <div className="flex items-center justify-end space-x-2 w-full">
            <Button variant="outline" onClick={() => onOpenChange(false)} disabled={loading} className="text-slate-300 border-slate-600 hover:bg-slate-700">
              Cancel
            </Button>
